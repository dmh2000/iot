...
const NMEA = (function () {
  ...
  nmea.encodeDate = function (d) {
    ...
    dy = d.getUTCDate();
    return (
      nmea.padLeft(dy.toString(), 2, "0") +
      nmea.padLeft(mn.toString(), 2, "0") +
      yr.toString().substr(2)
    );
  };
  ...
  nmea.GgaEncoder = function (id) {
    ...
    this.encode = function (id, data) {
      ...
      a.push(
        nmea.encodeValue(nmea.padLeft(data.satellites.toString(), 2, "0"))
      );
